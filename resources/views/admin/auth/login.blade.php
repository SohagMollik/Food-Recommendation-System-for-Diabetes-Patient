<x-admin-guest-layout>
    ...
    <form method="POST" action="{{ route('admin.login') }}">
        ...
        <div>
            ...
            <x-text-input id="email" placeholder="abc@gmail.com" class="block mt-1 w-full" type="email" name="email" :value="old('email')" required autofocus autocomplete="username" />
