...
<?php $component->withAttributes([]); ?>
    <br>
<a href="<?php echo e(route('dashboard')); ?>" class="btn btn-primary" style="margin-left: 10px;">Back</a>
...
<div class="container">
    ...
    <tbody>
        <?php $__currentLoopData = $breakfast; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $temp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
    ...
    <tbody>
    <?php $__currentLoopData = $lunch; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $temp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
                <td><?php echo e($temp->food_name); ?></td>
            </tr>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    ...
    <tbody>
    <?php $__currentLoopData = $dinner; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $temp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
                <td><?php echo e($temp->food_name); ?></td>
            </tr>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        ...
        <div style="display: flex; flex-wrap: wrap;">
            <div style="flex: 1; margin-left: 10px;">
                ...
                <select id="breakfastSelect" style="width: 75%" onchange="addToBox('breakfastSelect')">
                    <?php $__currentLoopData = $foods1; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <div style="display: flex; flex-wrap: wrap;">
            <div style="flex: 1; margin-left: 10px;">
                ...
                <select id="lunchSelect" style="width: 75%" onchange="addToBox('lunchSelect')">
                    <?php $__currentLoopData = $foods2; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($item->food_id); ?>"><?php echo e($item->food_id); ?>. <?php echo e($item->food_name); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
                <div class="selected-items-box">
        ...
        <div style="display: flex; flex-wrap: wrap;">
            <div style="flex: 1; margin-left: 10px;">
                ...
                <select id="dinnerSelect" style="width: 75%" onchange="addToBox('dinnerSelect')">
                    <?php $__currentLoopData = $foods3; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($item->food_id); ?>"><?php echo e($item->food_id); ?>. <?php echo e($item->food_name); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
                <div class="selected-items-box">
...
<?php endif; ?>
<?php /**PATH F:\Softwar\XAMPP\htdocs\food\resources\views/updatefood.blade.php ENDPATH**/ ?>